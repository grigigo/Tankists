...
public:
    ...
    void setupUi(QMainWindow *RegistrWindow)
    {
        ...
        login_->setMinimumSize(QSize(0, 75));
...
"}"));
        ...
        sizePolicy.setHeightForWidth(password_->sizePolicy().hasHeightForWidth());
        password_->setSizePolicy(sizePolicy);
        password_->setMinimumSize(QSize(0, 75));
...
"}"));
    ...
    void retranslateUi(QMainWindow *RegistrWindow)
    {
        ...
        label_3->setText(QCoreApplication::translate("RegistrWindow", "<html><head/><body><p><span style=\" font-size:28pt;\">\320\233\320\276\320\263\320\270\320\275</span></p></body></html>", nullptr));
        label_4->setText(QCoreApplication::translate("RegistrWindow", "<html><head/><body><p><span style=\" font-size:28pt;\">\320\237\320\260\321\200\320\276\320\273\321\214</span></p></body></html>", nullptr));
