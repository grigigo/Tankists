...
" }"));
        ...
        sign_up_button->setGeometry(QRect(9, 538, 302, 100));
        ...
        comboBox->setGeometry(QRect(9, 457, 264, 75));
        ...
        login_edit->setGeometry(QRect(9, 131, 106, 75));
        ...
        login_1->setGeometry(QRect(9, 9, 102, 45));
        QFont font1;
        ...
        back_button->setGeometry(QRect(9, 644, 93, 100));
        ...
        password_edit->setGeometry(QRect(9, 335, 106, 75));
        ...
        password_1->setGeometry(QRect(9, 212, 124, 45));
